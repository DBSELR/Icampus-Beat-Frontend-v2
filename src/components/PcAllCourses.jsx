...
const PcAllCourses = () => {
  ...
  const handleDownload = () => {
    ...
    a.href = url; a.download = `PC_AllCourses_${batch}.csv`; a.click();
      ...
      <div className={styles.panel}>
        <div className={styles.filtersRow}>
          ...
          <div className={styles.actionsGroup}>
            ...
            <button type='button' className={styles.printBtn} onClick={handlePrint} disabled={isLoading || tableData.length === 0}>
              Print
            </button>
          </div>
        </div>
