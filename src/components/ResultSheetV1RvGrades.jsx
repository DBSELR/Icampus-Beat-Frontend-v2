...
const ResultSheetV1RvGrades = () => {
  ...
  const handleDownload = () => {
    ...
    a.href = url; a.download = `ResultSheet_RvGrades_${sem}.csv`; a.click();
...
export default ResultSheetV1RvGrades;
