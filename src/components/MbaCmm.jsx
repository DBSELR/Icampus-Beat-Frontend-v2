...
import styles from './MbaCmm.module.css';
import { getAppData, getMbaCmmData } from '../utils/api';
...
const MbaCmm = () => {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    getMbaCmmData(course, examMY, regu)
      .then(res => {
    ...
    <div className={styles.container}>
      <div className={styles.panel}>
        <div className={styles.filtersRow}>
          <span className={styles.title}>MBA CMM REPORT</span>
