...
import styles from './ResultSheetSubjectModeration.module.css';
import { getAppData, getResultSheetModerationSems, getResultSheetModerationData } from '../utils/api';

const ResultSheetSubjectModeration = () => {
  ...
  useEffect(() => {
    ...
    getResultSheetModerationSems(course, examMY, regu)
      .then(res => {
  ...
  const handleView = async () => {
    ...
    setTableData([]);
    try {
      const res = await getResultSheetModerationData(course, examMY, regu, sem, isReadmit, readmitRegu.trim());
  ...
  const handleDownload = () => {
    ...
    a.href = url; a.download = `ResultSheet_Moderation_${sem}.csv`; a.click();
...
export default ResultSheetSubjectModeration;
